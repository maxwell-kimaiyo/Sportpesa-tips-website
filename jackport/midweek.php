    ...
    $sql = "SELECT * FROM `jackports` WHERE code = 'm2' LIMIT 5;";
...
.enclave__aws-comparison__actions {
    margin: 0 auto;
    transform: translateY(32px);
}

.btn-callout {
   background-image: linear-gradient(-35deg, #344758 0%, #29384f 42%, #1B283c 78%, #307AD1 100%);
    border-radius: 5px;
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <a href="index.html" class="logo">Sp<img src="../images/sportpesa1024.png" width="50" height="50"/>rtpesa Tips</a>
                <nav class="right">
                    <a href="../login"><button class="btn btn-banner btn-sm  button2  animated swing duration- animation-delay-6 "><i class="fa fa-user"></i> LOGIN</button></a>
                </nav>
            </header></div></div>
            <script>
function bigImg(x) {
        ...
        <!-- Menu -->
            <nav id="menu">
                ...
                <ul class="actions vertical ">
                    <li><a href="../login"><button class="button-fit btn btn-banner btn-sm button1"><i class="fa fa-user"></i> LOGIN</button></a>
                </ul>
            </nav>
        ...
        <div class="row">
            <div class="col-sm-12 text-center" style="background-color: #fff; padding: 0px;">
                <div class="well" style="border-radius: 0px; background-color: rgba(1,1,1,.1); margin-bottom: 0px; height: 100%; width: 100%; color: #307AD1; border: none;">
                    <h4 class="headerTitle" style="color: #307AD1 font-size:18px">Sportpesa Mini Jackpot predictions <br><small style="text-decoration: none;font-size: 18px;color: #29384f"><a href="../index.php">HOME</a> <i class="fa fa-chevron-circle-right"></i> Sportpesa Tips</small><br></h4>
        ...
        <div class="container" >
            <div class="row">
                <div class="col-sm-12  mt-30" >
                   <center>
                    <blockquote style="text-align: center; color: #29384f">Sportpesa Mini Jackpot predictions This Week:</blockquote>
            </center>
                </div>
                 <div class="col-md-12 mt10 nopaddingsmall " style="background-color: whitesmoke;">
                     <table class=" table tablestacked table-hover  table-condensed" style="background-color: #F4F6F6; border-color: #ffffff;table-layout: auto; font-size: 12px;" width="100%" class="table table-striped myTableSmall">
                            <thead style="text-align: center!important; color: whitesmoke; background-color: #29384f!important;">
                                        <tr>
                                            ...
                                            <td style="width: 66%;">Match</td>
                                            <td style="width: 15%;">Tip</td>
                                        </tr>
                                        </thead>
                                    
                                        
                 <tbody class="table-hover" style="text-align: center!important; font-size: 14px; color: #00060c; background-color: #eaeef2!important; "> 
                   <?php 
                        if ($resultcheck > 0) {
                    ...
                    <tr style="height: 21px;">
                        <td style=" font-size: 14px;background-color: #29384f; color:#fff"><?php echo $row['no'];   ?></td>
                        <td style="font-size: 14px;background-color: #ffffff; font-family: 'Noto Sans JP', sans-serif;"><?php echo $row['date'];   ?></td>
                        ...
                        <td style="font-size: 15px;color: #307AD1"><?php echo $row['tip'];   ?></td>
                    </tr>
                      <?php }} ?>
                </tbody>
            </table>
                          <div class="col-sm-12">
                        <center><a href="mega.php"><button class="btn btn-md button"> Mega Jackpot</button></a></center>
                                                        <br>
                    </div>
                </div>
            </div>
        </div>
         <CENTER><div class="enclave__aws-comparison__actions btn-callout">
                        Get ALL 13 Games Now&gt;&gt;
                        <a href="../registered.php" style="color:#307AD1">Tap here to Register→</a> Already Registered
                        <a href="../login.php" style="color:#307AD1">Tap here to Login→</a>
                    </div></CENTER>
    </section>
    </div>
    <div>
                ...
                <div class="row">
                    <div class="col-md-4 three_clo">
                      <h4>Contact Information</h4>
                        ...
                        <p><i class="fas fa-envelope "></i> Email Us:<span class="number"><a href="maxwellkimayo70@gmail.com " class="info" style="text-decoration: none;color: white; font-size: 14px"> info@sporttips.com</a></span></p>
