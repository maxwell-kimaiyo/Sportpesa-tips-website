        ...
        <div class="row">
            <div class="col-sm-12 text-center" style="background-color: #fff; padding: 0px;">
                <div class="well" style="border-radius: 0px; background-color: rgba(1,1,1,.1); margin-bottom: 0px; height: 100%; width: 100%; color: #307AD1; border: none;">
                    <h4 class="headerTitle" style="color: #307AD1 font-size:18px">Results<br><small style="text-decoration: none;font-size: 18px;color: #29384f"><a href="../index.php">HOME</a> <i class="fa fa-chevron-circle-right"></i> Sportpesa Tips</small><br></h4>
...
$sql = "SELECT * FROM `results` WHERE code = 'r3' LIMIT 10;";
...
?>
         <section id="section">
            ...
            <div class="row">
                 <div class="col-sm-8 col-sm-offset-2 mt30">
                    <blockquote>See our recent winning archives below!</blockquote>
                </div>
                 <div class="col-md-12 col-sm-offset-0 mt10 nopaddingsmall " style="background-color: whitesmoke;">
                            ...
                            <thead style="text-align: center!important; color: whitesmoke; background-color: #29384f!important;">
                                        <tr>
                                           <td style="width: 10%;">Date</td>
                                            <td style="width: 68%;">Picks</td>
                                            <td style="width: 10%;">Tip</td>
                                            <td style="width: 12%;">Result</td>
                                        </tr>
                                        </thead>
                    ...
                    <tr style="height: 21px;">
                        ...
                        <td style="background: #29384f!important"><span><strong style="color: #307AD1"><?php echo $row['result'];   ?></strong></span></td>
                    </tr>
                <?php }} ?>
                </tbody>
                </table>
    ...
    <center><div class="pagination" >  
                        <ul class="pagination">
                            <li><a href="result2.php" rel="prev">&laquo;</a></li>
                            <li ><a href="result1.php"> <span>1</span></a></li>
                            <li><a href="result2.php">2</a></li>
                            <li class="active"><a href="results3.php">3</a></li>
                            <li><a href="result4.php">4</a></li>
                            <li class="disabled"><span>...</span></li>
                            <li><a href="result13.php">13</a></li>
                           <li><a href="result4.php" rel="next">&raquo;</a></li>
                       </ul>
