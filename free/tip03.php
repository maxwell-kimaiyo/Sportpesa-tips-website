...
body{
    ...
    <body>
        ...
        <!-- Header -->
            ...
            <header id="header">
                ...
                <a href="../index.phd" class="logo" id="top">Sp<img src="../images/sportpesa1024.png" width="50" height="50"/>rtpesa Tips</a>
                <nav class="right">
    ...
    $sql = "SELECT * FROM `freetips` WHERE code = 'f2' LIMIT 10;";
...
?>
    ...
    <center><div class="pagination" >  
                        <ul class="pagination">
                            <li ><a href="tip.php" rel="prev">&laquo;</a></li>
                            <li ><a href="tip.php"> <span>1</span></a></li>
                            <li class="active" ><a href="tip03.php">2</a></li>
                            <li ><a href="tip04.php">3</a></li>
                           <li><a href="tip04.php" rel="next">&raquo;</a></li>
                       </ul>
