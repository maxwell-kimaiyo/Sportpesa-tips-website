...
<!-- Menu -->
    ...
    $sql = "SELECT * FROM `freetips` WHERE code = 'f4' LIMIT 10;";
...
?>
    ...
    <center><div class="pagination" >  
                        <ul class="pagination">
                            <li><a href="tip3.php" rel="prev">&laquo;</a></li>
                            <li ><a href="tip.php"> <span>1</span></a></li>
                            <li ><a href="tip03.php">2</a></li>
                            <li class="active"><a href="tip04.php">3</a></li>
            ...
            <div class="container">
                <div class="row">
                 ...
                 <center> <div class="copyright">
                    &copy; 2019 Sportpesa Predictions. 
        </footer>
